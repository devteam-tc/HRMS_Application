  ...
  content.innerHTML = `
    <div style="width: 100%; max-width: 800px; margin: 0 auto; padding: 15px; box-sizing: border-box;">
      ...
      <div style="text-align: center; margin-bottom: 15px; padding-bottom: 10px; border-bottom: 2px solid #f0f0f0;">
        <div style="font-size: 20px; font-weight: bold; color: #000; margin-bottom: 5px; letter-spacing: 0.5px;">TECH CLOUD ERP SOFTWARE PVT. LTD.</div>
        <div style="font-size: 11px; color: #000; margin-bottom: 5px;">Plot No. 241, 3rd Floor, VVG Elite, Kavuri Hills, Madhapur, Hyderabad, Telangana - 500081.</div>
      </div>
